...
import { calcularMetaCarteira, calcularPotencialCarteira, calcularPotencialCliente, distribuirMetaPorPotencial, limitarPercentualAcerto, normalizarValorNaoNegativo } from "@/utils/businessRules";
...
export default function Configuracoes() {
  ...
  const vendedoresComerciais = useMemo(() => [...new Set([...vendedores.map((v) => v.nome), ...clientes.map((c) => c.vendedor?.trim() || "Não definido")])].filter(Boolean).sort(), [vendedores, clientes]);
