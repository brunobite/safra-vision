...
export const initialProdutos: Produto[] = [
  { id: "p1", codigo: "ADJ-001", nome: "ADJ Performance", categoria: "Adjuvantes", linha: "Performance", unidade: "L", fornecedor: "Quimagro", precoLista: 85, precoMinimo: 70, custo: 50, margem: 41, estoqueAtual: 400, estoqueReservado: 50, localEstoque: "CD Bagé", ultimaAtualizacao: diasAtras(2), ativo: true },
  { id: "p2", codigo: "NUT-010", nome: "Nutri Special K", categoria: "Nutrição", linha: "Especial", unidade: "Kg", fornecedor: "AgroNutri", precoLista: 120, precoMinimo: 95, custo: 70, margem: 41, estoqueAtual: 80, estoqueReservado: 20, localEstoque: "CD Pelotas", ultimaAtualizacao: diasAtras(5), ativo: true },
  { id: "p3", codigo: "FER-200", nome: "Fertilizante NPK 10-20-10", categoria: "Fertilizantes", linha: "Premium", unidade: "Ton", fornecedor: "Fertipampa", precoLista: 3200, precoMinimo: 2800, custo: 2400, margem: 25, estoqueAtual: 25, estoqueReservado: 5, localEstoque: "CD Bagé", ultimaAtualizacao: diasAtras(1), ativo: true },
  { id: "p4", codigo: "SEM-050", nome: "Semente Soja R7", categoria: "Sementes", linha: "Elite", unidade: "Sc", fornecedor: "SeedBR", precoLista: 850, precoMinimo: 780, custo: 700, margem: 17, estoqueAtual: 5, estoqueReservado: 0, localEstoque: "CD Pelotas", ultimaAtualizacao: diasAtras(7), ativo: true },
  { id: "p5", codigo: "DEF-300", nome: "Defensivo Glifo X", categoria: "Defensivos", linha: "Standard", unidade: "L", fornecedor: "Quimagro", precoLista: 45, precoMinimo: 38, custo: 28, margem: 38, estoqueAtual: 1200, estoqueReservado: 200, localEstoque: "CD Bagé", ultimaAtualizacao: diasAtras(3), ativo: true },
  { id: "p6", codigo: "BIO-100", nome: "Bio Inoc Plus", categoria: "Biológicos", linha: "Bio", unidade: "L", fornecedor: "BioAgro", precoLista: 65, precoMinimo: 55, custo: 38, margem: 41, estoqueAtual: 0, estoqueReservado: 0, localEstoque: "CD Pelotas", ultimaAtualizacao: diasAtras(10), ativo: true },
];
